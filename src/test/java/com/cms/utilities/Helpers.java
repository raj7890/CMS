...
public class Helpers {
	...
	//Method to verify element exists
	...
	public void click(By locator,String Elementname)
	{
		...
		if(elementexists(locator)){
			...
			bconfig.SuccessReport("Sucessfully clicked on "+ Elementname);
		}else{
			bconfig.FailureReport("Element not Found "+Elementname);
		}
	}
	...
	public void setValue(By locator, String value,String Elementname)
	{
		
		if(elementexists(locator)){
			driver.findElement(locator).sendKeys(value);
			bconfig.SuccessReport("Sucessfully Entered value:"+value +"on "+ Elementname);
		}else{
			bconfig.FailureReport("Element not Found "+Elementname);
		}
	}
	...
	public void openURL(String url,String Env)
	{	if(Env.equalsIgnoreCase("TestEnv")){	
	...
	//Method to copydata to clipboard
	public void copydatatoclipboard(String filepath)
	{
		
		StringSelection sel = new StringSelection(filepath);
		Toolkit.getDefaultToolkit().getSystemClipboard().setContents(sel,null);
		 System.out.println("selection" +filepath);
	}
}
